...
// node_modules/@supabase/functions-js/node_modules/cross-fetch/dist/node-ponyfill.js
var require_node_ponyfill2 = __commonJS({
  "node_modules/@supabase/functions-js/node_modules/cross-fetch/dist/node-ponyfill.js"(exports2, module2) {
...
var require_helper = __commonJS({
  "node_modules/@supabase/functions-js/dist/main/helper.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.resolveFetch = void 0;
    var cross_fetch_1 = __importDefault(require_node_ponyfill2());
    var resolveFetch = (customFetch) => {
      let _fetch;
      if (customFetch) {
        _fetch = customFetch;
...
var require_makeRequest = __commonJS({
  "node_modules/stripe/lib/makeRequest.js"(exports2, module2) {
    ...
    function getRequestOpts(self2, requestArgs, spec, overrideData) {
      const requestMethod = (spec.method || "GET").toUpperCase();
      const urlParams = spec.urlParams || [];
      const encode = spec.encode || ((data2) => data2);
      const isUsingFullPath = !!spec.fullPath;
      const commandPath = utils.makeURLInterpolator(isUsingFullPath ? spec.fullPath : spec.path || "");
      const path = isUsingFullPath ? spec.fullPath : self2.createResourcePathWithSymbols(spec.path);
      ...
      const requestPath = isUsingFullPath ? commandPath(urlData) : self2.createFullPath(commandPath, urlData);
    ...
    function makeRequest(self2, requestArgs, spec, overrideData) {
      return new Promise((resolve, reject) => {
        let opts;
        try {
          opts = getRequestOpts(self2, requestArgs, spec, overrideData);
        } catch (err) {
          reject(err);
          return;
        }
        ...
        self2._request(opts.requestMethod, opts.host, path, opts.bodyData, opts.auth, { headers, settings, streaming: opts.streaming }, requestCallback);
      });
    }
    ...
    function makeAutoPaginationMethods(self2, requestArgs, spec, firstPagePromise) {
      ...
      if (spec.methodType === "search") {
        getNextPagePromise = (pageResult) => {
          ...
          return makeRequest(self2, requestArgs, spec, {
...
// functions/add_product_to_db.js
var import_supabase_js = __toModule(require_main6());
var stripe = require_stripe()(process.env.GATSBY_STRIPE_SK);
var supabase = (0, import_supabase_js.createClient)(GATSBY_SUPABASE_URL, process.env.GATSBY_SUPABASE_KEY);
var endpointSecret = "whsec_0286817c32a272cf74a6260d4ebcf58cfa2dc19c850cb0c4ff8d24f734d9999b";
exports.handler = async ({ body, headers }) => {
  try {
    const stripeEvent = stripe.webhooks.constructEvent(body, headers["stripe-signature"], endpointSecret);
    ...
    return {
      statusCode: 400,
      body: `Webhook error: ${error2}`
    };
  }
};
//# sourceMappingURL=add_product_to_db.js.map

  ...
  if (allowSelling === true) {
        ...
        {loading ? (
          ...
          <section className={styles.products}>
            {products.map((product) => (
              <Link
                to={`/projects/${product.product_list[0].project_link}`}
    ...
    return (
      <main>
        ...
        <h3>
          Unfortunately we have temporarily restricted the sales of our
          products. We apologize for the inconvenience. Please come back at a
          later time to check the status.
        </h3>
      </main>
    );
  }

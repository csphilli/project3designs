  ...
  return (
    <section className={styles.section_container}>
      ...
      <section className={styles.purchase_container}>
        ...
        <PurchaseComponent
          products={products?.filter((item) => item.p3_id === base.p3_id)}
        />
      </section>
...
export const query = graphql`
  query ProjectDetails($project_link: String, $dir: String) {
    markdownRemark(frontmatter: { project_link: { eq: $project_link } }) {
      html
      frontmatter {
        title
        description
        ...
        post_banner {
          childImageSharp {
            gatsbyImageData(width: 1400, aspectRatio: 1.6, height: 300)
          }
        }
        post_thumb {
          childImageSharp {
